...
public class IsaacCongenialEngineer : PortalcraftCard, IEvolvableCard
{
    ...
    public virtual Type? EvolvedType      => sts2_char_portalcraft_CurrentTier == EvoTier.Base ? typeof(IsaacCongenialEngineerEvolved)      : null;
    public virtual Type? SuperEvolvedType => sts2_char_portalcraft_CurrentTier == EvoTier.Base ? typeof(IsaacCongenialEngineerSuperEvolved) : null;
