...
public class StrikePortalcraft : PortalcraftCard, IEvolvableCard
{
    [SavedProperty]
    ...
    public StrikePortalcraft() : this(EvoTier.Base) { }

    protected StrikePortalcraft(EvoTier tier)
    ...
    public virtual Type? EvolvedType      => sts2_char_portalcraft_CurrentTier == EvoTier.Base ? typeof(StrikePortalcraftEvolved)      : null;
    public virtual Type? SuperEvolvedType => sts2_char_portalcraft_CurrentTier == EvoTier.Base ? typeof(StrikePortalcraftSuperEvolved) : null;
