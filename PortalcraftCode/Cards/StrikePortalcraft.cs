...
public class StrikePortalcraft : PortalcraftCard, IEvolvableCard
{
    ...
    public virtual Type? EvolvedType      => Tier == EvoTier.Base ? typeof(StrikePortalcraftEvolved)      : null;
    public virtual Type? SuperEvolvedType => Tier == EvoTier.Base ? typeof(StrikePortalcraftSuperEvolved) : null;
