...
public class CamiscillaUnfeelingHeart : PortalcraftCard, IEvolvableCard
{
    ...
    public virtual Type? EvolvedType      => sts2_char_portalcraft_CurrentTier == EvoTier.Base ? typeof(CamiscillaUnfeelingHeartEvolved)      : null;
    public virtual Type? SuperEvolvedType => sts2_char_portalcraft_CurrentTier == EvoTier.Base ? typeof(CamiscillaUnfeelingHeartSuperEvolved) : null;
