...
public class PuppetCat : PortalcraftCard, IEvolvableCard
{
    ...
    public virtual Type? EvolvedType      => Tier == EvoTier.Base ? typeof(PuppetCatEvolved)      : null;
    public virtual Type? SuperEvolvedType => Tier == EvoTier.Base ? typeof(PuppetCatSuperEvolved) : null;
