...
public class ImariDewdrop : PortalcraftCard, IEvolvableCard
{
    ...
    public virtual Type? EvolvedType      => sts2_char_portalcraft_CurrentTier == EvoTier.Base ? typeof(ImariDewdropEvolved)      : null;
    public virtual Type? SuperEvolvedType => sts2_char_portalcraft_CurrentTier == EvoTier.Base ? typeof(ImariDewdropSuperEvolved) : null;
