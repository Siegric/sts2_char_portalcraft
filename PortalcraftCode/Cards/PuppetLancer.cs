...
public class PuppetLancer : PortalcraftCard, IEvolvableCard
{
    ...
    public virtual Type? EvolvedType      => sts2_char_portalcraft_CurrentTier == EvoTier.Base ? typeof(PuppetLancerEvolved)      : null;
    public virtual Type? SuperEvolvedType => sts2_char_portalcraft_CurrentTier == EvoTier.Base ? typeof(PuppetLancerSuperEvolved) : null;
