...
public class MechanizedBeast : PortalcraftCard, IEvolvableCard
{
    ...
    public virtual Type? EvolvedType      => Tier == EvoTier.Base ? typeof(MechanizedBeastEvolved)      : null;
    public virtual Type? SuperEvolvedType => Tier == EvoTier.Base ? typeof(MechanizedBeastSuperEvolved) : null;
