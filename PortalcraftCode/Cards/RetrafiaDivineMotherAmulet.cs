...
public sealed class RetrafiaDivineMotherAmulet : PortalcraftCard, ICountdownCard, ILastWordsCard
{
    ...
    public async Task OnLastWords(PlayerChoiceContext choiceContext)
    {
        ...
        await CardPileCmd.AddGeneratedCardToCombat(retrafia, PileType.Hand, true);
    }
}
