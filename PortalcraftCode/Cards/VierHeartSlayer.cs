...
public class VierHeartSlayer : PortalcraftCard, IEvolvableCard
{
    ...
    public virtual Type? EvolvedType      => Tier == EvoTier.Base ? typeof(VierHeartSlayerEvolved)      : null;
    public virtual Type? SuperEvolvedType => Tier == EvoTier.Base ? typeof(VierHeartSlayerSuperEvolved) : null;
