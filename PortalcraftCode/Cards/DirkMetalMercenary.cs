...
public class DirkMetalMercenary : PortalcraftCard, IEvolvableCard
{
    ...
    public DirkMetalMercenary() : this(EvoTier.Base) { }

    protected DirkMetalMercenary(EvoTier tier)
    ...
    public virtual Type? EvolvedType      => Tier == EvoTier.Base ? typeof(DirkMetalMercenaryEvolved)      : null;
    public virtual Type? SuperEvolvedType => Tier == EvoTier.Base ? typeof(DirkMetalMercenarySuperEvolved) : null;
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await SummonHelper.Summon<FortifierArtifact>(Owner, CombatState);
    }
