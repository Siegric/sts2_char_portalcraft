...
public class DirkMetalMercenary : PortalcraftCard, IEvolvableCard
{
    ...
    public virtual Type? EvolvedType      => sts2_char_portalcraft_CurrentTier == EvoTier.Base ? typeof(DirkMetalMercenaryEvolved)      : null;
    public virtual Type? SuperEvolvedType => sts2_char_portalcraft_CurrentTier == EvoTier.Base ? typeof(DirkMetalMercenarySuperEvolved) : null;
